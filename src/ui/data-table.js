...
export class DataTable extends BaseElement {
    ...
    getElementString() {
        ...
        return `
        <div class="content-grid mdl-grid" id="library-books-container">
                            ...
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control mdl-textfield__input" id="title" type="text" value="">
                                    </div>
                                    <div class="form-group">
                                        <label for="category">Category</label> 
                                        <input class="form-control mdl-textfield__input" id="category" type="text" value="">
                                    </div>
                                    <div class="form-group">
                                        <label for="author">Author</label> 
                                        <input class="form-control mdl-textfield__input" id="author" type="text" value="">
                                    </div>
                                    <div class="form-group">
                                        <label for="type">Type</label> 
                                        <input class="form-control mdl-textfield__input" id="type" type="text" value="">
                                    </div>                   
                                </div>
                                <div class="panel-footer">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <button type="button" class="buttonMargin btn btn-primary mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" id="updateButton" onclick="bookUpdate();">+</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
